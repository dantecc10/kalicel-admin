                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header p-2 px-md-3">
                            <h4 class="modal-title fw-bold ms-3" style="color: var(--bs-kalicel-rojo);">Registrar reparación</h4><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                                ...
                                <div class="row m-0">
                                    ...
                                    <div class="col col-12"><label class="form-label my-1 py-0" for="brand">Marca&nbsp;<span class="text-danger">*</span></label><select name="brand" class="form-select p-1" required>
                                            <optgroup label="Selecciona una marca">
                                                ...
                                                <option value="Otra">Otra (especifica en el modelo)</option>
                                            </optgroup>
                                        </select>
                                    </div>
                                    <div class="col col-12"><label class="form-label my-1 py-0" for="model">Modelo&nbsp;<span class="text-danger">*</span></label><input class="form-control p-1" type="text" name="model" required="" placeholder="Especifica el dispositivo (modelo)"></div>
                                    <div class="col col-12 col-md-6"><label class="form-label my-1 py-0 d-flex align-items-center" for="mobile">Número telefónico (<svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor">
                                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                                <path d="M224 122.8c-72.7 0-131.8 59.1-131.9 131.8 0 24.9 7 49.2 20.2 70.1l3.1 5-13.3 48.6 49.9-13.1 4.8 2.9c20.2 12 43.4 18.4 67.1 18.4h.1c72.6 0 133.3-59.1 133.3-131.8 0-35.2-15.2-68.3-40.1-93.2-25-25-58-38.7-93.2-38.7zm77.5 188.4c-3.3 9.3-19.1 17.7-26.7 18.8-12.6 1.9-22.4.9-47.5-9.9-39.7-17.2-65.7-57.2-67.7-59.8-2-2.6-16.2-21.5-16.2-41s10.2-29.1 13.9-33.1c3.6-4 7.9-5 10.6-5 2.6 0 5.3 0 7.6.1 2.4.1 5.7-.9 8.9 6.8 3.3 7.9 11.2 27.4 12.2 29.4s1.7 4.3.3 6.9c-7.6 15.2-15.7 14.6-11.6 21.6 15.3 26.3 30.6 35.4 53.9 47.1 4 2 6.3 1.7 8.6-1 2.3-2.6 9.9-11.6 12.5-15.5 2.6-4 5.3-3.3 8.9-2 3.6 1.3 23.1 10.9 27.1 12.9s6.6 3 7.6 4.6c.9 1.9.9 9.9-2.4 19.1zM400 32H48C21.5 32 0 53.5 0 80v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V80c0-26.5-21.5-48-48-48zM223.9 413.2c-26.6 0-52.7-6.7-75.8-19.3L64 416l22.5-82.2c-13.9-24-21.2-51.3-21.2-79.3C65.4 167.1 136.5 96 223.9 96c42.4 0 82.2 16.5 112.2 46.5 29.9 30 47.9 69.8 47.9 112.2 0 87.4-72.7 158.5-160.1 158.5z"></path>
                                            ...
                                            </svg>)&nbsp;<span class="text-danger">*</span></label><input class="form-control p-1" type="tel" name="mobile" required="" placeholder="Teléfono"></div>
                                    <div class="col col-12 col-md-6 visually-hidden"><label class="form-label my-1 py-0 d-flex align-items-center" for="email"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                                <path d="M464 64C490.5 64 512 85.49 512 112C512 127.1 504.9 141.3 492.8 150.4L275.2 313.6C263.8 322.1 248.2 322.1 236.8 313.6L19.2 150.4C7.113 141.3 0 127.1 0 112C0 85.49 21.49 64 48 64H464zM217.6 339.2C240.4 356.3 271.6 356.3 294.4 339.2L512 176V384C512 419.3 483.3 448 448 448H64C28.65 448 0 419.3 0 384V176L217.6 339.2z"></path>
                                            </svg>&nbsp;Correo electrónico&nbsp;</label><input class="form-control p-1" type="email" name="email" placeholder="correo@kalicel.com"></div>
                                    <div class="col col-12 col-sm-6"><label class="form-label my-1 py-0 align-items-center text-center col-12" for="cost"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -32 576 576" width="1em" height="1em" fill="currentColor">
                                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col align-self-center text-center col-2 p-0"><span class="m-0 p-0">$</span></div>
                                            <div class="col col-6 ps-0"><input class="form-control p-1 text-center" type="number" name="cost" placeholder="Precio" step=".01"></div>
                                        </div>
                                    </div>
                                    <div class="col col-12 col-sm-6 visually-hidden"><label class="form-label my-1 py-0 align-items-center col-12 text-center" for="paid_amount"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col align-self-center text-center col-2 p-0"><span class="m-0 p-0">$</span></div>
                                            <div class="col col-6 ps-0"><input class="form-control p-1 text-center" type="number" name="paid_amount" placeholder="Abono" step=".01"></div>
                                        </div>
                                    </div>
                                    <div class="col col-12"><label class="form-label my-1 py-0 d-flex align-items-center" for="fail"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                            ...
                                            </svg>&nbsp;Falla (diagnóstico)</label><input class="form-control p-1" type="text" name="fail" placeholder="Diagnóstico o falla"></div>
                                    <div class="col col-12 col-md-6 visually-hidden"><label class="form-label my-1 py-0 d-flex align-items-center" for="work"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -32 576 576" width="1em" height="1em" fill="currentColor">
                                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                            ...
                                            </svg>&nbsp;Trabajo u operación a realizar</label><input class="form-control p-1" type="text" name="work" placeholder="Sustitución o proceso a realizar"></div>
                                    <div class="col col-12"><label class="form-label my-1 py-0 d-flex align-items-center" for="comments"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor">
                                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                            ...
                                            </svg>&nbsp;Comentarios, instrucciones y notas</label><textarea class="form-control p-1" name="comments"></textarea></div>
                                </div>
                                <div class="modal-footer"><button class="btn btn-light" type="button" data-bs-dismiss="modal" style="background-color: var(--bs-gray-300);"><i class="fas fa-times-circle" style="color: var(--bs-kalicel-rojo) !important;"></i>&nbsp;Cerrar</button><button class="btn btn-primary custom-bg" type="submit" style="background-color: var(--bs-kalicel-rojo) !important;"><i class="fas fa-plus-square"></i>&nbsp;Añadir</button></div>
                            </form>
                        </div>
                    </div>
                </div>
