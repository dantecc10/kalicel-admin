                    ...
                    <div class="container-fluid"><button class="btn btn-link btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <form class="d-none d-sm-inline-block my-2 my-md-0 mw-100 navbar-search col-12">
                            <div class="input-group col-12"><input class="bg-light form-control border-0 small" type="text" placeholder="Buscar">
                                <div class="input-group-append"><button class="btn btn-primary py-0" type="button" style="background-color: var(--bs-kalicel-rojo);"><i class="fas fa-search"></i></button></div>
                            </div>
                        </form>
                        <ul class="navbar-nav flex-nowrap ms-auto m-0">
                                ...
                                <div class="row m-0">
                                    ...
                                    <div class="col col-12 col-md-6">
                                        <label class="form-label my-1 py-0 d-flex align-items-center" for="email"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                                            ...
                                            </svg>&nbsp;Correo electrónico&nbsp;</label><input class="form-control p-1" type="email" name="email" placeholder="correo@kalicel.com" />
                                    </div>
                                    ...
                                    <div class="col col-12 col-sm-6">
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col col-6 ps-0">
                                                <input class="form-control p-1 text-center" type="number" name="paid_amount" placeholder="Abono" step=".01" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col col-12 col-md-6">
                                    ...
                                    <div class="col col-12 col-md-6">
                                        <label class="form-label my-1 py-0 d-flex align-items-center" for="work"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -32 576 576" width="1em" height="1em" fill="currentColor">
                                            ...
                                            </svg>&nbsp;Trabajo u operación a realizar</label><input class="form-control p-1" type="text" name="work" placeholder="Sustitución o proceso a realizar" />
                                    </div>
                                    <div class="col col-12">
