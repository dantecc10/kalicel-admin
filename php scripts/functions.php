...
function table_builder($name)
{
                    ...
                    <td class="px-3">
                        <div class="col">
                            <div class="row">
                                ...
                                <a href="https://wa.me/52FLAG"> FLAG</a></span></div>
                            </div>
                            <div class="row">
    ...
    $supCont = ['<div id="tab-1" class="tab-pane active" role="tabpanel">', '</div>'];
