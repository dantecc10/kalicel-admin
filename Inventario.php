                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        while ($columna = mysqli_fetch_array($resultado)) {
                                            ...
                                            echo "<td><button id='baja" . $columna['id_display'] . "' class='btn btn-primary btn-baja' type='button'>-</button><span id='cantidad" . $columna['id_display'] .  "'>" . $columna['cantidad_display'] . "</span><button id='alta" . $columna['id_display'] . "' class='btn btn-primary btn-alta' type='button'>+</button></td>";
